...
To create a dashboard that provides insights into the top UK YouTubers in 2024 that their
- subscriber count
- total views
- total videos and
- engagement metrics.
...
-- 1.
SELECT 
	SUBSTRING(NOMBRE,1, CHARINDEX('@',NOMBRE)-1) AS Channel_names, -- 2.
	total_subscribers,
	total_views,
	total_videos
...
![PowerBi-Dashboard](https://raw.githubusercontent.com/MorkaNathaniel/top_uk_youtubers_2024/8e035ae6f9da0ea603a236cf4b3a8114942fed9f/asset/images/Top_YouTuber_2024.%20Dashboard%20(1).gif)
